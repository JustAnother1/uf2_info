...
static void reportFamilyId(uint32_t id)
{
    ...
    case 0x1c5f21b0: printf("espressif ESP32 (0x1c5f21b0)\n"); break;
    ...
    case 0x31d228c6: printf("GigaDevice GD32F350 (0x31d228c6)\n"); break;
    ...
    case 0x5a18069b: printf("Infineon (Cypress) FX2 (0x5a18069b)\n"); break;
    ...
    case 0x7eab61ed: printf("espressif ESP8266 (0x7eab61ed)\n"); break;
    ...
    case 0xbfdd4eee: printf("espressif ESP32-S2 (0xbfdd4eee)\n"); break;
    case 0xc47e5767: printf("espressif ESP32-S3 (0xc47e5767)\n"); break;
    case 0xd42ba06c: printf("espressif ESP32-C3 (0xd42ba06c)\n"); break;
    case 0x2b88d29c: printf("espressif ESP32-C2 (0x2b88d29c)\n"); break;
    case 0x332726f6: printf("espressif ESP32-H2 (0x332726f6)\n"); break;
